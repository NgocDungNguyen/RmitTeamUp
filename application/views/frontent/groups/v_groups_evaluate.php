<div class="max-w-3xl mx-auto">
   <div class="box relative rounded-lg shadow-md">
      ...
      <div id="setting_tab" class="uk-switcher md:py-12 md:px-20 p-6 overflow-hidden text-black text-sm">
         ...
         <div>
            <div class="mt-5">
               <form method="post" action="<?= base_url('groups-evaluate-check?codegroup='.$view_group['code_group'].'&code_user_group='.$code_user_group); ?>" class="space-y-7 text-sm text-black font-medium dark:text-white" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true" enctype="multipart/form-data">
                  <div class="space-y-6">
                   ...
                   <div class="md:flex items-center gap-10">
                     ...
                     <div class="md:flex items-start gap-10">
                        ...
                        <div class="flex-1 max-md:mt-4">
                           <textarea class="w-full" rows="5" name="content_evaluate"></textarea>
                        </div>
                     </div>
