      ...
      <main id="site__main" class="2xl:ml-[--w-side]  xl:ml-[--w-side-sm] p-2.5 h-[calc(100vh-var(--m-top))] mt-[--m-top]">
         <div class="max-w-3xl mx-auto">
            ...
            <p class="text-sm text-blue-600 mt-1 font-normal">@<?= $view_user['msv']; ?></p>
                  ...
                  <div>
                     <div uk-alert="" class="uk-alert">
                        <div class="p-2 border bg-green-50 border-green-500/30 rounded-xl dark:bg-slate-700">
                          ...
                          <!-- text -->
                          <div class="text-base text-green-700"> Bạn đã đăng kí thành công. Vui lòng điền các thông tin để xác minh danh tính. </div>
               ...
               <div class="mt-5">
                  <form method="post" action="<?= base_url('profile-active-check'); ?>" class="space-y-7 text-sm text-black font-medium dark:text-white" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true" enctype="multipart/form-data">
                  <div class="space-y-6">
                     ...
                     <div class="md:flex items-center gap-10">
                        ...
                        <div class="flex-1 max-md:mt-4">
                           <input type="text" name="nameuser" placeholder="<?= $view_user['username']; ?>" value="<?= $view_user['username']; ?>" class="lg:w-1/2 w-full" required>
                        </div>
                     </div>
                     <div class="md:flex items-center gap-10">
                        <label class="md:w-32 text-right"> Email(<span style="color:red">*</span>) </label>
                        <div class="flex-1 max-md:mt-4">
                           <input type="text" name="email" placeholder="info@mydomain.com" required class="w-full">
                        </div>
                     </div>
                     <div class="md:flex items-start gap-10">
                        <label class="md:w-32 text-right"> Giới thiệu </label>
                        <div class="flex-1 max-md:mt-4">
                           <textarea class="w-full" rows="5" name="userbio" placeholder="Nhập thông tin giới thiệu"></textarea>
                        </div>
                     </div>
                     <div class="md:flex items-center gap-10">
