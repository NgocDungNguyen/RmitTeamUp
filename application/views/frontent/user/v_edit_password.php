...
<div class="max-w-3xl mx-auto">
   <div class="box relative rounded-lg shadow-md">
      ...
      <div class="relative border-b" tabindex="-1" uk-slider="finite: true">
         <nav class="uk-slider-container overflow-hidden nav__underline px-6 p-0 border-transparent -mb-px">
            <ul class="uk-slider-items w-[calc(100%+10px)] !overflow-hidden" uk-switcher="connect: #setting_tab ; animation: uk-animation-slide-right-medium, uk-animation-slide-left-medium">
               <li class="w-auto pr-2.5"> <a href="#"> Thay đổi mật khẩu</a> </li>
            </ul>
         </nav>
      ...
      <div id="setting_tab" class="uk-switcher md:py-12 md:px-20 p-6 overflow-hidden text-black text-sm">
         ...
         <div>
            <div class="mt-5">
               <form method="post" action="<?= base_url('change-password-check'); ?>" class="space-y-7 text-sm text-black font-medium dark:text-white" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true" enctype="multipart/form-data">
                     <div class="md:flex items-center gap-10">
                        <label class="md:w-32 text-right">Mật khẩu cũ <span style="color:red">*</span></label>
                        <div class="flex-1 max-md:mt-4">
                           <input type="text" name="passold" required class="w-full">
                        </div>
                     </div>
                     <div class="md:flex items-center gap-10">
                        <label class="md:w-32 text-right">Mật khẩu mới <span style="color:red">*</span></label>
                        <div class="flex-1 max-md:mt-4">
                           <input type="text" name="passnew" required class="w-full">
                        </div>
                     </div>
                     <div class="md:flex items-center gap-10">
                        <label class="md:w-32 text-right">Nhập lại mật khẩu mới <span style="color:red">*</span></label>
                        <div class="flex-1 max-md:mt-4">
                           <input type="text" name="repassnew" required class="w-full">
                        </div>
                     </div>
