      ...
      <div class="sm:flex">
         <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10">
            <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
               <!-- logo image-->
               <a href="#"> <img src="<?= base_url('public/frontent/'); ?>assets/img/logo.png" class="w-28 absolute top-10 left-10 dark:hidden" alt=""></a>
               <a href="#"> <img src="<?= base_url('public/frontent/'); ?>assets/images/logo.png" class="w-28 absolute top-10 left-10 hidden dark:!block" alt=""></a>
               <!-- logo icon optional -->
               <div>
                  <h2 class="text-2xl font-semibold mb-1.5">Đăng nhập vào tài khoản của bạn </h2>
                  <p class="text-sm text-gray-700 font-normal">Nếu bạn chưa đăng ký. <a href="register" class="text-blue-700">Đăng ký ở đây!</a></p>
               </div>
               <!-- form -->
               <form method="post" action="<?= base_url('login-check'); ?>" class="space-y-7 text-sm text-black font-medium dark:text-white" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                  <?php if($this->session->flashdata('success')){ ?>
                     ...
                     <?php } ?>
                  <div>
                     <label for="email" class="">Mã sinh viên</label>
                     <div class="mt-2.5">
                        <input id="email" name="msv" type="text" autofocus="" placeholder="Mã sinh viên" required class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"> 
                     </div>
                  </div>
                  <!-- password -->
                  <div>
                  ...
                  <!-- submit button -->
                  <div>
                     <button type="submit" class="button bg-primary text-white w-full" name="login">Đăng nhập</button>
                  </div>
               </form>
            </div>
         </div>
